...
export default function SignUp() {
  ...
  const [selectedDate, setSelectedDate] = useState(dayjs("2003-01-01"));
  return (
    <div>
      <Grid
        container
            ...
            >
              <Box sx={{ mb: 2 }}>
                ...
                <Typography sx={{ color: theme.palette.text.secondary }}>
                  Sign up to enjoy the feature of Heron
                </Typography>
              </Box>
              <TextField
                fullWidth
          ...
          >
            <img
              ...
              style={{
                ...
                objectFit: "fill",
                borderRadius: "15px",
              }} // Apply width and height styles directly
            />
          </Box>
        </Grid>
      </Grid>
